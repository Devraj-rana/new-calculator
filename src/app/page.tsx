  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-background text-foreground font-body">
      ...
      <main className="container mx-auto flex flex-col items-center justify-center p-4">
        <h1 className="mb-4 bg-gradient-to-r from-primary via-blue-300 to-primary bg-clip-text text-center text-5xl font-bold text-transparent md:text-6xl font-headline">
          MathMaster
        </h1>
